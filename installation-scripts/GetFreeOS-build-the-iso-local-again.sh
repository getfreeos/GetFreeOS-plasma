...
echo
	...
	isoLabel='GetFreeOS-plasma-gaming-'$linuxVersion'.iso'
...
echo
	...
	newname1='iso_name="GetFreeOS-'$desktop

	oldname2='iso_label="arcolinuxl'
	newname2='iso_label="GetFreeOS-'$desktop

	oldname3='ArcoLinuxL'
	newname3='GetFreeOS-'$desktop

	#hostname
	oldname4='ArcoLinuxL'
	newname4='GetFreeOS-'$desktop
...
echo
	...
	#Wael"
	sudo rm -fr /home/wael/GetFreeOS-build/GetFreeOS-build/x86_64/airootfs/etc/calamares/
	sudo cp -fr /mnt/Store/Linux/GetFreeOS/Plasma/MyFiles/all/* /home/wael/GetFreeOS-build/GetFreeOS-build/x86_64/airootfs/
